...
from graphs.models.minigpt4.models.Qformer import BertConfig, BertLMHeadModel
...
class MiniGPT4(MiniGPTBase):
    ...
    def __init__(
        ...
        if prompt_path:
            ...
            xm.master_print('Load {} training prompts'.format(len(self.prompt_list)))
            xm.master_print('Prompt Example \n{}'.format(random.choice(self.prompt_list)))
        else:
            self.prompt_list = []
